...
export default function Navbar() {
    ...
    return (
        <header className="w-full bg-white border-b relative">
            ...
            {isMenuOpen && (
                <div className="absolute top-full left-0 w-full bg-white border-b shadow-lg lg:hidden z-10 flex flex-col p-6 gap-4 animate-in fade-in slide-in-from-top-2">
                    ...
                    <Link href="/signup" className="sm:hidden text-blue-600 font-bold">Sign Up</Link>
                </div>
            )}
        </header>
    );
